...
public interface ReviewReactionCountRepository extends JpaRepository<ReviewReactionCountEntity, Long> {
    Optional<ReviewReactionCountEntity> findByReviewId(MoveReviewEntity reviewId); // 将 Long 改为 MoveReviewEntity
    ReviewReactionCountEntity findByReviewId_ReviewId(Long reviewId);
}
